...
urlpatterns = patterns('',
    ...
    url(r'^admin/update/?$',views.admin_update, name = "admin_update"),
    url(r'^admin/update/attendance/?$',views.admin_update_attendance, name = "admin_update_attendance"),
    ...
    url(r'^admin/calendar/?$',views.admin_calendar_view, name = "admin_calendar_view"),
