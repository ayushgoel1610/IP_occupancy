...
def authenticate_user(email):
  if email in ["digvijay09020@iiitd.ac.in","psingh@iiitd.ac.in","ayush12029@iiitd.ac.in","ashutosh@iiitd.ac.in","anshu@iiitd.ac.in","priti@iiitd.ac.in","joy1410@iiitd.ac.in"]:
    return True
  else:
    return False
